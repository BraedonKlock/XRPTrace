    ...
    return (
        ...
        {!hasTx ? (
            ...
            <div className="tx-details">
                <h5>
                <span className="labels">TRANSACTION HASH:</span>
                <br />
                {displayNode?.hash}
                </h5>
                <h5>
                <span className="labels">Address:</span> {displayNode?.address}
                </h5>
                <h5>
                <span className="labels">Amount:</span> {displayNode?.amount} XRP
                </h5>
                <h5>
                <span className="labels">Date:</span> {displayNode?.date}
                </h5>
            </div>
            ...
            <section className="graph-wrapper">
                ...
                <span className="graph-zoom-label">
                    {" "}
                    {Math.round(zoom * 100)}%{" "}
                </span>
